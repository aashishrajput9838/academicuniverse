...
v8_docx_path = workspace / "docs" / "paper" / "PaperV8_Ollama_Primary.docx"
v8_pdf_path = workspace / "docs" / "paper" / "PaperV8_Ollama_Primary.pdf"

print("============================================================")
print(" GENERATING PAPER V8 (LIMITATIONS ANALYSIS REMOVED & V8 COMPILED)")
print("============================================================")
...
# V8 Table of Contents entries: Clean 7 sections
toc_entries = [
    ("1. Introduction", "4", 1),
    ("2. Related Work", "5", 1),
    ("3. Methodology", "7", 1),
    ...
    ("6. Future Work", "21", 1),
    ("7. Conclusion", "21", 1),
    ("Ethics & Privacy Statement", "21", 1),
    ("ACKNOWLEDGMENT", "22", 1),
    ("APPENDIX A: REPRODUCIBILITY & SYSTEM SPECIFICATIONS", "22", 1),
    ("A.1 Reproducibility & System Environment Matrix", "22", 2),
    ("A.2 Technical Clarifications & Reviewer Inquiries", "23", 2),
    ("APPENDIX B: FIELD SPECIFICATION & OBSERVATION COUNT DERIVATION", "23", 1),
    ("B.1 Document Category Field Structure", "23", 2),
    ("B.2 Mathematical Derivation of 24,480 Paired Observations", "23", 2),
    ("APPENDIX C: EMPIRICAL STATISTICAL METHODOLOGY & BENCHMARKS", "24", 1),
    ("C.1 Empirical Category Confusion Matrix (360 Specimens)", "24", 2),
    ("C.2 McNemar Contingency Test & Normalization Rescues", "24", 2),
    ("C.3 Non-Parametric Bootstrap Confidence Intervals (B = 10,000)", "25", 2),
    ("REFERENCES", "25", 1),
]
...
doc.save(v8_docx_path)
print(f"[SUCCESS] Saved clean PaperV8_Ollama_Primary.docx with Limitations Analysis removed & renumbered!")

# Export PDF via Word COM Automation
print(f"Exporting PDF via Word COM Automation: {v8_pdf_path.name}...")
abs_docx = os.path.abspath(str(v8_docx_path))
abs_pdf = os.path.abspath(str(v8_pdf_path))
...
try:
    ...
    doc_word.Close()
    print(f"[SUCCESS] Exported high-quality PDF: {v8_pdf_path.name} ({page_count} Pages!)")
