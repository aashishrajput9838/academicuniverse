...
expected_title = "Smart Academic Document Intelligence System for Automated Academic Document Extraction and Normalization"

print("============================================================")
print(" VERIFYING NEW PAPER TITLE IN PaperV5_Ollama_Primary.docx")
print("============================================================")
...
forbidden_terms = ["ADBG", "AU DIC", "DIC", "Reproducible", "Evaluation and Normalization Framework"]
...
print(f"4. Page 1 Sharda University Logo Present: {has_logo}")
print(f"5. Page 2 CONTENTS Header Present:        {has_contents}")
...
print("EMPIRICAL VERIFICATION SUCCESSFUL: New paper title updated perfectly!")
