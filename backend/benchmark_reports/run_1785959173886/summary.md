...
**Run ID**: `run_1785959173886`  
**Timestamp**: `2026-08-05T20:50:48.067Z`  
...
| **Field F1 Score** | **17.19%** | ≥ 85.00% | WARNING |
| **Mean CER** | **82.76%** | ≤ 5.00% | WARNING |
| **Mean WER** | **84.12%** | ≤ 10.00% | WARNING |
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **clean** | 90 | 100.00% | 81.88% | 18.05% | 0.00% |
| **scanner_copy** | 90 | 100.00% | 83.04% | 16.92% | 0.00% |
| **mobile_camera** | 90 | 100.00% | 83.51% | 16.41% | 0.00% |
| **rotated_90** | 90 | 100.00% | 82.60% | 17.38% | 0.00% |
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **certificates** | 120 | 100.00% | 74.05% | 26.11% | 0.00% |
| **marksheets** | 120 | 100.00% | 94.44% | 5.56% | 0.00% |
| **student_ids** | 120 | 100.00% | 79.78% | 19.90% | 0.00% |
---
...
| :--- | :---: | :--- |
| **Average Confidence (Overall)** | **1497.67%** | Mean confidence across all evaluations |
| **Average Confidence (Correct)** | **0.00%** | Mean confidence for accurate predictions |
| **Average Confidence (Incorrect)**| **1497.67%** | Mean confidence for inaccurate predictions |
| **Overconfidence Gap** | **1497.67%** | Calibration discrepancy penalty |
...
| :--- | :---: | :--- |
| **OCR_ERROR** | 693 | Misread characters/digits from raw scan/photo |
| **FIELD_MISSING** | 2871 | Ground truth expected value omitted by model |
| **HALLUCINATION** | 0 | Model predicted value not present in ground truth |
| **FORMAT_ERROR** | 174 | Unparseable or invalid date/number string format |
