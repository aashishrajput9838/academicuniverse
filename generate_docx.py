...
def build_docx():
    ...
    docx_path = r"c:\github\academicuniverse.com\academicuniverse\Academic_Universe_Paper2_v1.0_Final.docx"
    ...
    while i < len(lines):
        ...
        if line.startswith('# '):
            ...
            if line.startswith('**Author**:') or line.startswith('*Figure') or line.startswith('*Table'):
                p.paragraph_format.space_after = Pt(4)
