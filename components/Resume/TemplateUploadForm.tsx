  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="mb-2">
        ...
        <p className="text-slate-400 text-sm">Upload a `.docx` resume template for students to seamlessly download to their devices.</p>
      </div>
      ...
      <form onSubmit={uploadTemplate} className="animate-in fade-in pt-2">
        <div 
