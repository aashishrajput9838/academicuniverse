...
| **Evaluated Neural Engine** | Groq Cloud AI (`minicpm-v:latest`, temperature=0.2, max_tokens=8192) |
...
$$\chi^2 = \frac{(|b - c| - 1)^2}{b + c} = \frac{(|167 - 0| - 1)^2}{167 + 0} = \frac{166^2}{167} = 1853.0005 \quad (p < 0.0001)$$
