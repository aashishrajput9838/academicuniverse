"""
ADBG Marksheet Generator Plugin.

Concrete implementation of DocumentGenerator for academic marksheets.
Renders clean PDFs with multi-semester grade tables using ReportLabTemplateRenderer.
...
class MarksheetGenerator(DocumentGenerator):
    """
    Document generator plugin for academic marksheets.
    """
    ...
    def generate(
        ...
        """
        Render marksheet document to PDF bytes.
        """
