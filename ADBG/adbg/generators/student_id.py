"""
ADBG Student ID Generator Plugin.

Concrete implementation of DocumentGenerator for student identity cards.
Renders clean PDFs with student demographic data using ReportLabTemplateRenderer.
...
class StudentIDGenerator(DocumentGenerator):
    """
    Document generator plugin for student identity cards.
    """
    ...
    def generate(
        ...
        """
        Render student ID document to PDF bytes.
        """
