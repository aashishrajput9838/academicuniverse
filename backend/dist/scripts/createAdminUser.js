...
async function createAdminUser() {
    try {
        ...
        let organization = await Organization_1.default.findOne({ slug: 'sharda-university' });
        if (!organization) {
            organization = await Organization_1.default.create({
        ...
        let adminRole = await Role_1.default.findOne({
            name: 'ADMIN',
