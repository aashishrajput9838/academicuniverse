...
v6_docx_path = workspace / "docs" / "paper" / "PaperV6_Ollama_Primary.docx"
v6_pdf_path = workspace / "docs" / "paper" / "PaperV6_Ollama_Primary.pdf"

print("============================================================")
print(" GENERATING PAPER V6 (SECTIONS 1, 2, 3, 4, & 5 RESTRUCTURED)")
print("============================================================")
...
# V6 Table of Contents entries: "1. Introduction", "2. Related Work", "3. Methodology", "4. Experimental Setup" (4.1 to 4.6)
toc_entries = [
    ("1. Introduction", "4", 1),
    ("2. Related Work", "5", 1),
    ("3. Methodology", "7", 1),
...
doc.save(v6_docx_path)
print(f"[SUCCESS] Saved clean PaperV6_Ollama_Primary.docx with Section 4 restructured!")

# Export PDF via Word COM Automation
print(f"Exporting PDF via Word COM Automation: {v6_pdf_path.name}...")
abs_docx = os.path.abspath(str(v6_docx_path))
abs_pdf = os.path.abspath(str(v6_pdf_path))
...
try:
    ...
    doc_word.Close()
    print(f"[SUCCESS] Exported high-quality PDF: {v6_pdf_path.name} ({page_count} Pages!)")
