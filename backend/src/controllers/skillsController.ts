...
function toSkillRecordDTO(record: any): SkillRecordDTO {
  return {
    ...
    scoringModelVersion: record.scoringModelVersion || 'SIE-1.0',
    proficiencyLevel: record.proficiencyLevel,
    proficiencyScore: record.proficiencyScore,
    confidenceScore: record.confidenceScore ?? 0.75,
    verificationStatus: record.verificationStatus || 'MEDIUM_CONFIDENCE',
    scoreBreakdown: record.scoreBreakdown || { volume: 50, recency: 0.8, ownership: 1.0, complexity: 1.1, dominance: 0.8 },
    recruiterExplanation: record.recruiterExplanation || '',
    evidenceCount: record.evidenceCount,
    evidenceSources: record.evidenceSources || ['GITHUB'],
    timelineData: record.timelineData || [],
