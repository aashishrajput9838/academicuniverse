...
v10_docx_path = workspace / "docs" / "paper" / "PaperV10_Ollama_Primary.docx"
v10_pdf_path = workspace / "docs" / "paper" / "PaperV10_Ollama_Primary.pdf"

print("============================================================")
print(" GENERATING PAPER V10 (ALL APPENDICES REMOVED & V10 COMPILED)")
print("============================================================")
...
# V10 Table of Contents entries: Clean 7 sections
toc_entries = [
    ("1. Introduction", "4", 1),
    ("2. Related Work", "5", 1),
    ("3. Methodology", "7", 1),
...
doc.save(v10_docx_path)
print(f"[SUCCESS] Saved clean PaperV10_Ollama_Primary.docx with All Appendices removed!")

# Export PDF via Word COM Automation
print(f"Exporting PDF via Word COM Automation: {v10_pdf_path.name}...")
abs_docx = os.path.abspath(str(v10_docx_path))
abs_pdf = os.path.abspath(str(v10_pdf_path))
...
try:
    ...
    doc_word.Close()
    print(f"[SUCCESS] Exported high-quality PDF: {v10_pdf_path.name} ({page_count} Pages!)")
