...
**Run ID**: `run_1787075827413`  
**Timestamp**: `2026-08-18T18:45:09.782Z`  
...
| **Field F1 Score** | **14.92%** | ≥ 85.00% | WARNING |
| **Mean CER** | **86.75%** | ≤ 5.00% | WARNING |
| **Mean WER** | **89.23%** | ≤ 10.00% | WARNING |
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **clean** | 1 | 0.00% | 85.07% | 11.49% | 0.00% |
| **scanner_copy** | 1 | 100.00% | 96.48% | 5.37% | 0.00% |
| **mobile_camera** | 1 | 100.00% | 78.69% | 27.91% | 0.00% |
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **certificates** | 2 | 50.00% | 81.88% | 19.70% | 0.00% |
| **marksheets** | 1 | 100.00% | 96.48% | 5.37% | 0.00% |
...
| **FIELD_MISSING** | 33 | Ground truth expected value omitted by model |
...
| **PARTIAL_MATCH** | 3 | Partial character similarity (0.01 < CER <= 0.50) |
