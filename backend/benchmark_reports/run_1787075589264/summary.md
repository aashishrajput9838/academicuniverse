...
**Run ID**: `run_1787075589264`  
**Timestamp**: `2026-08-18T17:57:07.078Z`  
...
| **Field F1 Score** | **16.22%** | ≥ 85.00% | WARNING |
| **Mean CER** | **87.74%** | ≤ 5.00% | WARNING |
| **Mean WER** | **90.63%** | ≤ 10.00% | WARNING |
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **clean** | 1 | 100.00% | 87.74% | 16.22% | 0.00% |
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **certificates** | 1 | 100.00% | 87.74% | 16.22% | 0.00% |
...
| **FIELD_MISSING** | 13 | Ground truth expected value omitted by model |
...
| **PARTIAL_MATCH** | 1 | Partial character similarity (0.01 < CER <= 0.50) |
...
| **Most Difficult Field** | **rollNumber** | Field with highest total extraction discrepancies |
