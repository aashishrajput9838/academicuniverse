...
print("============================================================")
print(" REBUILDING PAPER V5 (PAGE 1 = CONTENTS, PAGE 2 = FRONT MATTER, PAGE 3 = INTRO)")
print("============================================================")
...
# 6. Pipeline Fix: Place CONTENTS on PAGE 1, Front Matter (Title/Authors/Abstract) on PAGE 2, and Intro on PAGE 3
p_title = doc.paragraphs[0]

# Insert CONTENTS Heading at the absolute start of document (PAGE 1)
...
# Recalculated Page Numbers: Page 1 = TOC, Page 2 = Front Matter (Title/Authors/Abstract), Page 3 = Introduction
toc_entries = [
    ("1. Introduction", "3", 1),
...
# Set Page Break on p_title so Title starts on PAGE 2
p_title.paragraph_format.page_break_before = True

# Set Page Break on 1. Introduction so Main Paper starts on PAGE 3
for p in doc.paragraphs:
...
print(f"[SUCCESS] Saved PaperV5_Ollama_Primary.docx with PAGE 1 = CONTENTS, PAGE 2 = FRONT MATTER, PAGE 3 = INTRO!")
