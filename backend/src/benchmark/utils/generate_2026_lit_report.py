"""
2025-2026 Related Work Update Report Generator
==============================================
Generates RELATED_WORK_2026_UPDATE_REPORT.md detailing the expansion of Section 2
with 2025-2026 Document AI / VLM literature, updated comparison table, and research gap.
"""
...
report_content = """# OFFICIAL 2025–2026 RELATED WORK & LITERATURE UPDATE REPORT
...
with open(os.path.join(REPORT_DIR, 'RELATED_WORK_2026_UPDATE_REPORT.md'), 'w', encoding='utf-8') as f:
    f.write(report_content)
with open(os.path.join(BRAIN_DIR, 'RELATED_WORK_2026_UPDATE_REPORT.md'), 'w', encoding='utf-8') as f:
    f.write(report_content)

print("RELATED_WORK_2026_UPDATE_REPORT.md generated successfully!")
