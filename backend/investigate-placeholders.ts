...
async function main() {
  ...
  console.log('Has tables:', extractedDoc.hasTables);
  console.log('Has images:', extractedDoc.hasImages);
  ...
  console.log('Issues:', detectedSections.issues);
  ...
  if (injectionResult.success) {
    ...
    if (genResult.success) {
      ...
      console.log('XML (first 500 chars):', finalXml.substring(0, 500));
      ...
      try {
        ...
        console.log(renderedXml.substring(0, 500));
        console.log('...');
